...
$.extend(Timepicker.prototype, {
	...
	_parseTime: function(timeString, withDate) {
		...
		if (withDate || !this._defaults.timeOnly) {
			...
			regstr = '.{' + dp_dateFormat.length + ',}\\s*' + this._defaults.separator.replace(/\s/g, '\\s?') + regstr + this._defaults.lastSeparator.replace(/\s/g, '\\s?');
		}
	...
	_updateDateTime: function(dp_inst) {
		...
		if (this._defaults.timeOnly === true) {
			...
			formattedDateTime += this._defaults.separator + this.formattedTime + this._defaults.lastSeparator;
		}
